...
<b>┃🎞️ Total Episodes:</b> <i>{t_eps}</i>
<b>┃📅 Episode:</b> <i>{ep_no}</i>
<b>┃🔊 Audio:</b> <i>Japanese</i>
<b>┃💬 Subtitle:</b> <i>English</i>
<b>╰━━━━━━━━━━━━━━━⟡</b>
<b>╭━━━━━━━━━━━━━━━⟡</b>
<b>┃⚡ <i>Powered By:</i> <b>{cred}</b></b>
<b>╰━━━━━━━━━━━━━━━⟡</b>
"""
...
class TextEditor:
    ...
    async def get_upname(self, qual=""):
        anime_name = self.pdata.get("anime_title")
        codec = 'HEVC' if 'libx265' in ffargs[qual] else 'AV1' if 'libaom-av1' in ffargs[qual] else 'AVC' if 'libx264' in ffargs[qual] else 'shit'
